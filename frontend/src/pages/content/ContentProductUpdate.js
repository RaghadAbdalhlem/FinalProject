...
const ContentProductUpdate = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { data: product, refetch } = useGetProductByIdQuery(id); // Fetch the existing product data by ID
...
export default ContentProductUpdate;
